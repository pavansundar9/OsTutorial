...
function checkPriorityCell() {
    ...
    const priorityCell = document.querySelector('.priority');
    
    if (selectedAlgorithm === 'pnp' || selectedAlgorithm === 'pp') {
        // Show the priority cell for these algorithms
        priorityCell.classList.remove('hide');
    } else {
        // Hide the priority cell for other algorithms
        priorityCell.classList.add('hide');
    }
}
